...
export default {
  ...
  data() {
    return {
      texts: {
        resolved: '<p>Поздравляем, вы решили задачу! Я — Катя, цифровой ассистент из аудиторско-консалтинговой сети фирм PwC в&nbsp;России.</p><p>Мир меняется, и&nbsp;с&nbsp;каждым годом мы ищем всё больше талантливых людей, которые разбираются в&nbsp;современных технологиях. Вы&nbsp;выскользнули из&nbsp;лабиринта между сном и&nbsp;реальностью, а&nbsp;это производит впечатление.</p><p v-if="!isFilled">Заполните анкету, если будет интересно, чтобы мы пригласили вас на&nbsp;собеседование. Мы&nbsp;ознакомимся с&nbsp;данными и&nbsp;найдём самый короткий промежуток между&nbsp;X1 (настоящим моментом) и&nbsp;X5 (интервью).</p>',
        resolvedAndFilled: '<p>Поздравляем, вы решили задачу! Я — Катя, цифровой ассистент из аудиторско-консалтинговой сети фирм PwC в&nbsp;России.</p><p>Мир меняется, и&nbsp;с&nbsp;каждым годом мы ищем всё больше талантливых людей, которые разбираются в&nbsp;современных технологиях. Вы&nbsp;выскользнули из&nbsp;лабиринта между сном и&nbsp;реальностью, а&nbsp;это производит впечатление.</p>',
